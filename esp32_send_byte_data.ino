...
//==================================================================================//
void canSender() {
  uint8_t data[] = {random(255), random(255), random(255), random(255),random(255), random(255), random(255), random(255)};
  ...
  for (int i = 0; i < dataSize; i++) {
    CAN.write(data[i]); // write data to buffer. data is not sent until endPacket() is called.
  }
